...
The search script lives inside this skill's own directory. Invoke it by the path below, relative to the project root (or use the equivalent absolute path) — do not assume a particular working directory:
